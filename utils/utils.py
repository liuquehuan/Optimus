    ...
    for i in range(num_stream):
        ...
        for id in range(22):
            ...
            if min(cost) == 6000000000000:
                ...
                if 'Execution Time' in plans[start + id + 22 * cost.index(min(cost))]:
...
def run_ap_with_tp(sql, param, TP_WORKERS, controller, timeout=300000, tp_explain=False, tp_analyze=False, pool=None, manager=None):
