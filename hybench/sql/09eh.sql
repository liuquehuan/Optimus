...
and exists (select *
from loanapps la
where la.applicantid=c.companyid and date(timestamp::timestamp)
between '2023-11-01' and (cast('2023-11-01' as date) + 60))
and not exists (select * from loantrans lt
where lt.applicantid=c.companyid and date(timestamp::timestamp)
between '2023-11-01' and (cast('2023-11-01' as date) + 60))
